...
<?php if (!empty($aspirasi)): ?>
    ...
    <div class="tab-content" id="statusTabsContent">
                        ...
                        <div class="card card-aspirasi h-100 status-<?= strtolower($a->status) ?>">
                            ...
                            <div class="card-body">
                                ...
                                <?php if (!empty($a->gambar)): ?>
                                    <?php
                                    $fn = trim($a->gambar);
                                    $imgUrl = base_url('uploads/aspirasi/' . rawurlencode($fn));
                                    ?>
                                    <div class="mb-3">
                                        <img src="<?= $imgUrl ?>" alt="Bukti" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover;" loading="lazy">
                                    </div>
                                    <!-- debug: filename=<?= htmlspecialchars($fn) ?> url=<?= $imgUrl ?> -->
                                    <?php if (!file_exists('./uploads/aspirasi/' . $fn)): ?>
                                        <div class="text-danger small">gambar file tidak ditemukan di disk</div>
                                    <?php endif; ?>
                                <?php endif; ?>
                                ...
                                <?php if ($a->status == 'Proses' || $a->status == 'Selesai'): ?>
                                    <div class="alert alert-info py-2 px-3" role="alert">
                                        <small>
                                            <i class="fas fa-info-circle me-1"></i> <strong>Status Progres:</strong>
                                            <?= ($a->status == 'Proses') ? 'Aspirasi Anda sedang diproses oleh admin' : 'Aspirasi Anda telah selesai diproses'; ?>
                                        </small>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($a->feedback): ?>
                                    <div class="feedback-section">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <strong class="text-success"><i class="fas fa-reply me-1"></i> Umpan Balik Admin</strong>
                                        ...
                                        <?php if ($a->feedback_gambar): ?>
                                            <img src="<?= base_url('uploads/feedback/' . htmlspecialchars($a->feedback_gambar)) ?>" alt="Feedback" class="img-fluid rounded" style="max-height: 300px; width: 100%; object-fit: cover;" loading="lazy">
                                        <?php endif; ?>
                                    </div>
                                <?php else: ?>
        ...
        <div class="tab-pane fade" id="menunggu" role="tabpanel">
            <div class="row">
                <?php
                $menunggu = array_filter($aspirasi, function ($a) {
                    return $a->status == 'Menunggu';
                });
                if (!empty($menunggu)):
                        ...
                        <div class="col-lg-4 mb-4" data-aos="fade-up">
                            <div class="card card-aspirasi h-100 status-<?= strtolower($a->status) ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php if ($a->gambar): ?>
                                        <div class="mb-3">
                                            <img src="<?= base_url('uploads/aspirasi/' . htmlspecialchars($a->gambar)) ?>" alt="Bukti" class="img-fluid rounded" style="max-height: 250px; width: 100%; object-fit: cover;" loading="lazy">
                                        </div>
                                    <?php endif; ?>
        ...
        <div class="tab-pane fade" id="proses" role="tabpanel">
            <div class="row">
                <?php
                $proses = array_filter($aspirasi, function ($a) {
                    return $a->status == 'Proses';
                });
                if (!empty($proses)):
                    foreach ($proses as $a):
                            ...
                            <div class="card card-aspirasi h-100 status-<?= strtolower($a->status) ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info py-2 px-3" role="alert">
                                        <small>
                                            <i class="fas fa-info-circle me-1"></i> <strong>Status Progres:</strong>
                                            Aspirasi Anda sedang diproses oleh admin
                                        </small>
                                    </div>
        ...
        <div class="tab-pane fade" id="selesai" role="tabpanel">
            <div class="row">
                <?php
                $selesai = array_filter($aspirasi, function ($a) {
                    return $a->status == 'Selesai';
                });
                if (!empty($selesai)):
                            ...
                            <div class="card card-aspirasi h-100 status-<?= strtolower($a->status) ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-info py-2 px-3" role="alert">
                                        <small>
                                            <i class="fas fa-info-circle me-1"></i> <strong>Status Progres:</strong>
                                            Aspirasi Anda telah selesai diproses
                                        </small>
                                    </div>
                                    ...
                                    <?php else: ?>
                                        <div class="alert alert-warning py-2 px-3" role="alert">
                                            <small>Menunggu feedback tertulis...</small>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
